...
#### 프로그래머스 사용법
- https://school.programmers.co.kr/ 진입
- 회원가입(생략)
- 로그인 후 코딩테스트 메뉴
- 스킬체크 시작
- 문제풀이 화면(에디터)으로 변경. 힌트 확인
...
| 순번 | 시간복잡도        | 최대 연산 횟수 (1초당 기준) | 비고 |
|------|-------------------|-----------------------------|------|
| 1    | O(log n)          | 1,000,000,000               | 단일 for문 중간 연산을 빠지는 경우가 매우 많은 경우 (예: 369 문제) |
| 2    | O(n)              | 10,000,000                  | for문 사용 / 반복문 하나 사용 |
| 3    | O(n log n)        | 1,000,000                   | 2중 for문에서 반복문 하나가 log n 횟수로 연산 |
| 4    | O(n²)             | 3,000                       | 2중 for문 |
| 5    | O(n³)             | 300                         | 3중 for문 |
| 6    | O(2ⁿ)             | 20                          | 재귀호출, DFS, 백트래킹 |
...
3. `제출 후 채점하기` 클릭
    ...
    <img src='./image/ct0003.png' width='500'>
...
- https://github.com/hugoMGSung 주소에 com -> dev
    ...
    <img src='./image/ct0004.png' width='500'>
